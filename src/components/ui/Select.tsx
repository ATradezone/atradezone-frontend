    ...
    <div className={className} ref={wrapperRef}>
      ...
      <div className="relative pr-8 text-gray-500">
        <input
          ...
          style={{ paddingTop: '0.2rem', paddingBottom: '0.2rem', fontFamily: 'Afacad, sans-serif', fontSize: '16px', color: '#7d7d7d' }}
          {...props} // Spread any additional props
        />
        ...
        {swapActionButtonPosition ? (
          ...
          <>
            ...
            {addonIcon && (
              <div className="absolute inset-y-0 right-18 flex items-center px-2 pointer-events-none">
                {addonIcon}
              </div>
            )}
          </>
          ...
          <>
            ...
            {addonIcon && (
              <div className="absolute inset-y-0 right-14 flex items-center px-2 pointer-events-none">
                {addonIcon}
              </div>
            )}
          </>
