        ...
        <div className="flex-1 p-0.3 overflow-y-auto rounded-r-xl" style={{ marginLeft: '1.5rem' }}>
          ...
          <div className="bg-white rounded-xl p-6 mb-6 pt-0 shadow-sm">
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="h-4 bg-gray-300 rounded w-32 ml-8"></div>
            </div>
              ...
              {[1, 2, 3].map((item) => (
                <div key={item} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                  ...
                  <div className="space-y-2">
                    {[1, 2, 3, 4].map((feature) => (
                      <div key={feature} className="h-3 bg-gray-300 rounded"></div>
                    ))}
                  </div>
...
export default RenewalBillingSkeleton;