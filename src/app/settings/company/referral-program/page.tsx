...
const ReferralProgramPage = () => {
  ...
  const [guideLine, setGuideLine] = useState({
    ...
    step2: 'They sign up and subscribe to a plan',
    step3: 'You earn credits for each successful referral',
    step4: 'Apply credits to your next renewal for discounts'
  });
  ...
  const [editedPaymentMethod, setEditedPaymentMethod] = useState('Bank Transfer');
            ...
            <div id="earnings" className="bg-white rounded-xl p-6 mb-6 pt-0 shadow-sm" style={{ scrollMarginTop: '3rem' }}>
              <div className="flex items-center justify-between mb-0">
                ...
                <div className="flex items-center space-x-2 bg-blue-50 px-3 py-1 rounded-full" style={{ boxShadow: 'rgb(220, 234, 255) 0px 0px 5px 1px', backgroundColor: 'rgb(255, 255, 255)' }}>
                  ...
                  <span className="text-sm font-afacad text-blue-900">$500</span>
                </div>
              </div>
              {/* Full-width divider */}
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <StatCard title="Amount" className="p-4">
                      <div className="h-px bg-[#EAECF0] my-4 -mx-4"></div>
                      <p className="text-lg font-medium text-gray-900">${payout.amount}</p>
                    </StatCard>
