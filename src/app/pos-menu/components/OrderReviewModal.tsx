      ...
      <div className="overflow-y-auto max-h-[60vh] pr-2 grid grid-cols-1 lg:grid-cols-2 gap-0">
        ...
        <div>
          ...
          >
                ...
                {/* Show phone number, TIN number, and company name below customer name */}
                {(phoneNumber || tinNumber || companyName) && (
            ...
            >
              ...
              <div className="overflow-x-auto mt-2">
                {/* Made the table container scrollable with increased height for empty state */}
                <div className="min-h-40 max-h-40 overflow-y-auto">
