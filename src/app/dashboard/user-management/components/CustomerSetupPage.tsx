...
const CustomerSetupPage = () => {
  ...
  // Form state for customer profile
  ...
  // Form state for additional customer information
  ...
  // Form state for customer address
  ...
  const insuranceTypes = [
    ...
    { value: 'rssb', label: 'RSSB Insurance' },
    { value: 'old-mutual', label: 'Old Mutual Insurance' },
    { value: 'britam', label: 'Britam Insurance' },
    { value: 'alliance', label: 'Alliance Insurance Brokers (AIB)' },
    { value: 'bk-general', label: 'BK General Insurance Company' },
    { value: 'britam-rwanda', label: 'Britam Insurance Company Rwanda Ltd' },
    { value: 'mayfair', label: 'Mayfair Insurance Company Rwanda Ltd' },
    { value: 'mua', label: 'MUA' },
    { value: 'phoenix', label: 'Phoenix Of Rwanda Assurance Co Ltd' },
    { value: 'prime-life', label: 'Prime Life Assurance Limited' },
    { value: 'radiant', label: 'Radiant Insurance Company' },
    { value: 'reliance', label: 'Reliance Insurance Services Co. Ltd' },
    { value: 'soras', label: 'Soras (Member Of Sanlam Group)' },
    { value: 'uap', label: 'UAP Insurance' },
    { value: 'utmost', label: 'Utmost Insurance Brokers' }
  ];

  // Steps configuration
  const steps = [
    { id: 'profile-additional', title: 'Customer Profile' },
    { id: 'address', title: 'Customer Address' },
  ...
  const handleProfileAdditionalSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Customer profile data submitted:', customerData);
          ...
          <div id="profile-additional" className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 pt-0 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col">
                  <AutoCompleteSelect
                    ...
                    onChange={(value) => handleAdditionalChange({ target: { name: 'gender', value } } as React.ChangeEvent<HTMLInputElement>)}
                    options={[
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="flex flex-col">
                  <AutoCompleteSelect
                    label="Insurance ID Type"
                    name="insuranceIdType"
                    value={additionalData.insuranceIdType}
                    onChange={(value) => handleAdditionalChange({ target: { name: 'insuranceIdType', value } } as React.ChangeEvent<HTMLInputElement>)}
                ...
                <div className="flex flex-col"  >
                  <Input
                    ...
                    value={additionalData.insuranceNumber}
                    onChange={handleAdditionalChange}
            ...
            {/* Remove the duplicate Continue button that was here */}
          </div>
        );
      case 1:
        return (
