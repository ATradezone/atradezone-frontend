...
interface SupplierManagementSidebarProps {
...
const SupplierManagementSidebar: React.FC<SupplierManagementSidebarProps> = ({ 
  activeSection, 
  onSectionChange,
  supplierData = {
    companyName: '',
  ...
  const sidebarItems = [
    { id: 'profile-additional', label: 'Supplier Profile', icon: <TeamOutlined /> },
    { id: 'address', label: 'Supplier Address', icon: <SettingOutlined /> },
      ...
      <div className="w-52" style={{marginTop: '-20px', paddingBottom: '5px', fontFamily: 'Afacad, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
        ...
        <div className="mb-0">
          ...
          <p className="text-gray-600 mt-0" style={{ color: '#000000', fontFamily: 'Afacad, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
            Manage supplier profile, account settings, and permissions
          </p>
        </div>
        <div 
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="flex items-center mb-3">
          <div className="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center" style={{ boxShadow: 'rgb(220, 234, 255) 0px 0px 5px 1px', backgroundColor: 'rgb(255, 255, 255)' }}>
            <TeamOutlined className="text-[#2663eb]" />
          </div>
          
          {/* Section 2 & 3: Supplier Name, Phone, Email (stacked vertically) */}
            ...
            <div className="flex flex-col">
              <div className="flex items-center truncate">
                ...
                <span 
                  ...
                  title={supplierData.companyName || 'N/A'}
                >
              ...
              <div className="flex items-center truncate">
                ...
                <span 
                  className="text-xs text-gray-500 truncate"
                  title={supplierData.emailAddress || 'N/A'}
                >
                  {supplierData.emailAddress || 'N/A'}
                </span>
              </div>
              <div className="flex items-center truncate">
                ...
                <span 
                  className="text-xs text-gray-500 truncate"
                  title={supplierData.phoneNumber || 'N/A'}
                >
...
export default SupplierManagementSidebar;