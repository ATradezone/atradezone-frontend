...
interface InsuranceAutoCompleteSelectProps {
  label?: string;
...
const InsuranceAutoCompleteSelect = ({
  label,
  labelAlign = 'left',
  value,
  onChange,
...
}: InsuranceAutoCompleteSelectProps) => {
        ...
        {isOpen && !disabled && (
          <div className="absolute z-20 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-auto">
            {filteredOptions.length === 0 ? (
              <div className="px-4 py-2 text-gray-500">No Insurance found</div>
            ) : (
...
export default InsuranceAutoCompleteSelect;